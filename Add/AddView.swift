                ...
                VStack {
                    ...
                    ZStack {
                        ...
                        VStack(alignment: .center) {
                            HStack{
                                ...
                                Text("저장")
                                    .onTapGesture {
                                        ...
                                        statisticsStore.send(.setnumOfToDoPerWeek(add: true, numOfIter: viewStore.iter.count))
                                        statisticsStore.send(.setnumOfToDoPerMonth(add: true, numOfIter: viewStore.iter.count))
                            ...
                            HStack{
                                ForEach(1..<8){
                                    WeekButton(weekOfDay: $0, iter: viewStore.iter, OnOff: viewStore.selectedHabit?.weekIter.contains($0) ?? false ? true : false)
                                }
                            }
